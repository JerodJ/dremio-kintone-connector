...
3. Download and install the [Kintone JDBC Driver from CData](https://www.cdata.com/drivers/kintone/download/jdbc)* and copy the JAR file to the /jars/3rdparty/ directory of your Dremio installation. For example:
