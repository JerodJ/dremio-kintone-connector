...
@SourceType(value = "KintoneARP", label = "Kintone",uiConfig = "kintone-layout.json")
public class KintoneConf extends AbstractArpConf<KintoneConf> {
  private static final String ARP_FILENAME = "arp/implementation/kintone-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.kintone.KintoneDriver";
